...
class MenuManager:
    def __init__(self):
        ...
        # Set title
        if os.name == 'nt':
            os.system("title SSFN Logger Tool • Main Menu • discord.gg/kws")
    ...
    def display_add_menu(self):
        os.system("title SSFN Logger Tool • Add Account Menu • discord.gg/kws")
        self.add_menu_handler.display_add_menu()

    def display_remove_menu(self):
        os.system("title SSFN Logger Tool • Remove Account Menu • discord.gg/kws")
        self.remove_menu_handler.display_remove_menu()
    
    def display_log_menu(self):
        os.system("title SSFN Logger Tool • Log in Menu • discord.gg/kws")
        self.log_menu_handler.display_log_menu()
        
    def print_logs_box(self):
        os.system("title SSFN Logger Tool • Showing logs • discord.gg/kws")
